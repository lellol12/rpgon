...
const ITEM_DATA = {
    "commonHerbs": { name: "Common Herbs", description: "Basic herbs for alchemy.", type: "material", tier: 1, gameAsset: 'items/commonHerbs.png' },
    "roughIronOre": { name: "Rough Iron Ore", description: "Unrefined ore for forging.", type: "material", tier: 1, gameAsset: 'items/roughIronOre.png' },
    "blankTalismanPaper": { name: "Blank Talisman Paper", description: "Paper for drawing talismans.", type: "material", tier: 1, gameAsset: 'items/blankTalismanPaper.png' },
    "monsterCoreWeak": { name: "Monster Core (Weak)", description: "A weak core from a defeated monster.", type: "material", tier: 1, gameAsset: 'items/monsterCoreWeak.png' },
    "beastBoneFragment": { name: "Beast Bone Fragment", description: "A fragment of a beast's bone.", type: "material", tier: 2, gameAsset: 'items/beastBoneFragment.png' },
    "spiritDust": { name: "Spirit Dust", description: "Residue with faint spiritual energy.", type: "material", tier: 2, gameAsset: 'items/spiritDust.png' },
    "spiritStoneFragment": { name: "Spirit Stone Fragment", description: "A small piece of a spirit stone.", type: "material", tier: 1, gameAsset: 'items/spiritStoneFragment.png' },
    "spiritStones": { name: "Spirit Stones", description: "Currency of the cultivation world.", type: "currency", gameAsset: 'items/spiritStones.png' },

    "minorHealingPill": { name: "Minor Healing Pill", description: "Restores a small amount of health.", type: "consumable", gameAsset: 'items/minorHealingPill.png', effect: (player) => { const heal = 25; player.health = Math.min(player.maxHealth, player.health + heal); displayMessage(`Used Minor Healing Pill. Restored ${heal} HP.`, "item-use"); player.resources.minorHealingPill--; updateStatsDisplay(player); Game.saveCurrentPlayerState();}, usableInCombat: true },
    "minorQiPill": { name: "Minor QI Pill", description: "Restores a small amount of QI.", type: "consumable", gameAsset: 'items/minorQiPill.png', effect: (player) => { const qiRestore = 20; player.currentQi = Math.min(player.maxQi, player.currentQi + qiRestore); displayMessage(`Used Minor QI Pill. Restored ${qiRestore} QI.`, "item-use"); player.resources.minorQiPill--; updateStatsDisplay(player); Game.saveCurrentPlayerState();}, usableInCombat: true },
    "roughSword": { name: "Rough Sword", description: "A crudely made sword. Phys. Attack +5.", type: "weapon", weaponPhysicalAttackBonus: 5, gameAsset: 'items/roughSword.png', equipEffect: (player) => { player.equippedWeapon = "roughSword"; player.weaponPhysicalAttackBonus = 5; displayMessage("Equipped Rough Sword.", "item-use"); updateStatsDisplay(player); Game.saveCurrentPlayerState(); } },
    "minorFireTalisman": { name: "Minor Fire Talisman", description: "Unleashes a small burst of fire. (10 QI)", type: "talisman", qiCost: 10, baseDamage: 15, gameAsset: 'items/minorFireTalisman.png', effectInCombat: (player, opponent) => { if (player.currentQi >= 10) { player.currentQi -= 10; const spellDamage = Game.ITEM_DATA.minorFireTalisman.baseDamage + Math.floor(player.getSpellPower() / 2); displayCombatAction(`${player.name} uses a Minor Fire Talisman!`, "combat-text-player-action"); const damageResult = opponent.takeDamage(spellDamage); appendCombatAction(damageResult.message, damageResult.style); updateStatsDisplay(player); Game.saveCurrentPlayerState(); return true;} else { appendCombatAction("Not enough QI to use Fire Talisman!", "error"); return false;} } },

    "jadeleafGrass": { name: "Jadeleaf Grass", description: "Common herb that mildly restores qi.", type: "material", tier: 1, gameAsset: 'items/jadeleafGrass.png' },
    "crimsonSpiritBerry": { name: "Crimson Spirit Berry", description: "Used for blood regeneration and minor injuries.", type: "material", tier: 1, gameAsset: 'items/crimsonSpiritBerry.png' },
    "soothingRainPetal": { name: "Soothing Rain Petal", description: "Calms qi deviation; heals minor spiritual wounds.", type: "material", tier: 2, gameAsset: 'items/soothingRainPetal.png' },
    "moondewFlower": { name: "Moondew Flower", description: "A gentle restorative for mind and body.", type: "material", tier: 2, gameAsset: 'items/moondewFlower.png' },
    "earthrootGinseng": { name: "Earthroot Ginseng", description: "Recovers qi and physical stamina.", type: "material", tier: 3, gameAsset: 'items/earthrootGinseng.png' },
    "skyLotusBud": { name: "Sky Lotus Bud", description: "Advanced qi restoration, often used by Core cultivators.", type: "material", tier: 4, gameAsset: 'items/skyLotusBud.png' },
    "whisperingLeaf": { name: "Whispering Leaf", description: "Promotes faster energy circulation during rest.", type: "material", tier: 3, gameAsset: 'items/whisperingLeaf.png' },
    "radiantSunfruit": { name: "Radiant Sunfruit", description: "Restores both qi and vitality rapidly.", type: "material", tier: 4, gameAsset: 'items/radiantSunfruit.png' },
    "cloudmossVine": { name: "Cloudmoss Vine", description: "Stimulates spiritual veins; best for Nascent Soul users.", type: "material", tier: 5, gameAsset: 'items/cloudmossVine.png' },
    "spiritglowMushroom": { name: "Spiritglow Mushroom", description: "Heals internal meridian damage.", type: "material", tier: 5, isRare: true, gameAsset: 'items/spiritglowMushroom.png' },

    "breakthroughVine": { name: "Breakthrough Vine", description: "Helps cultivators leap into Foundation Establishment.", type: "material", tier: 1, isRare: true, forRealmBreak: 2, gameAsset: 'items/breakthroughVine.png' },
    "dragonboneFern": { name: "Dragonbone Fern", description: "Used in pills to stabilize Core Formation.", type: "material", tier: 2, isRare: true, forRealmBreak: 3, gameAsset: 'items/dragonboneFern.png' },
    "phoenixbloodHerb": { name: "Phoenixblood Herb", description: "Burns away impurities; ideal for advancing into Nascent Soul.", type: "material", tier: 3, isRare: true, forRealmBreak: 4, gameAsset: 'items/phoenixbloodHerb.png' },
    "ascensionOrchid": { name: "Ascension Orchid", description: "Rare orchid that assists in Soul Formation breakthroughs.", type: "material", tier: 4, isRare: true, forRealmBreak: 5, gameAsset: 'items/ascensionOrchid.png' },
    "heavenpierceRoot": { name: "Heavenpierce Root", description: "Violently clears bottlenecks; high risk, high reward.", type: "material", tier: 4, isRare: true, forRealmBreak: 5, gameAsset: 'items/heavenpierceRoot.png' },
    "divineFlameGrass": { name: "Divine Flame Grass", description: "Contains pure yang energy; used for fiery breakthroughs.", type: "material", tier: 3, isRare: true, gameAsset: 'items/divineFlameGrass.png' },
    "lunarBloom": { name: "Lunar Bloom", description: "Yin energy concentrated herb, used in realm balance pills.", type: "material", tier: 3, isRare: true, gameAsset: 'items/lunarBloom.png' },
    "immortaldustleaf": { name: "Immortal Dustleaf", description: "Needed for Transcendence Elixirs.", type: "material", tier: 5, isRare: true, forRealmBreak: 6, gameAsset: 'items/immortalDustleaf.png' },
    "voidberryThorn": { name: "Voidberry Thorn", description: "Bitter but crucial for soul ascension.", type: "material", tier: 5, isRare: true, forRealmBreak: 6, gameAsset: 'items/voidberryThorn.png' },
    "thunderclapFruit": { name: "Thunderclap Fruit", description: "Shocks dantian to force enlightenment at high realms.", type: "material", tier: 5, isRare: true, gameAsset: 'items/thunderclapFruit.png' },

    "starforgePetal": { name: "Starforge Petal", description: "A petal that glimmers with starlight.", type: "material", tier: 4, gameAsset: 'items/starforgePetal.png' },
    "stoneheartRoot": { name: "Stoneheart Root", description: "A root as hard as stone, imbued with earth essence.", type: "material", tier: 4, gameAsset: 'items/stoneheartRoot.png' },
    "spiriteyeFlower": { name: "Spirit-Eye Flower", description: "A flower that seems to gaze into the spiritual realm.", type: "material", tier: 3, gameAsset: 'items/spiritEyeFlower.png' },
    "heartblossomBud": { name: "Heartblossom Bud", description: "A bud said to open one's heart to spiritual senses.", type: "material", tier: 3, gameAsset: 'items/heartblossomBud.png' },
    "silverstormLeaf": { name: "Silverstorm Leaf", description: "A leaf that moves with incredible speed, even in stillness.", type: "material", tier: 3, gameAsset: 'items/silverstormLeaf.png' },
    "goldendantianFruit": { name: "Golden Dantian Fruit", description: "A fruit believed to strengthen a cultivator's core.", type: "material", tier: 4, gameAsset: 'items/goldenDantianFruit.png' },
    "blackflameGinseng": { name: "Blackflame Ginseng", description: "Ginseng that smolders with dark fire.", type: "material", tier: 4, isRare: true, gameAsset: 'items/blackflameGinseng.png' },
    "frostmarrowMoss": { name: "Frostmarrow Moss", description: "Moss that chills to the bone, yet preserves essence.", type: "material", tier: 4, isRare: true, gameAsset: 'items/frostmarrowMoss.png' },
    ...
    "harmonizingBellvine": { name: "Harmonizing Bellvine", description: "A vine whose flowers chime with balancing energies.", type: "material", tier: 5, gameAsset: 'items/harmonizingBellvine.png' },
    "eyeOfTheAncients": { name: "Eye of the Ancients", description: "A petrified eye that seems to hold ancient knowledge.", type: "material", tier: 5, isRare: true, gameAsset: 'items/eyeOfTheAncients.png' },
    ...
    "spiritboundBlade": {
        ...
        slot: "weapon",
        tier: 1,
        weaponPhysicalAttackBonus: 10,
        stats: { strength: 6 },
        gameAsset: 'assets/equipment/SpiritboundBlade.png',
    ...
    "spiritboundMail": {
        ...
        gameAsset: 'assets/equipment/SpiritboundMailArmor.png',
    ...
    "spiritbandRing": {
        ...
        slot: "ring1",
        stats: { spirit: 5 },
        gameAsset: 'assets/equipment/SpiritbandRing.png',
    ...
    "spiritstepBoots": {
        ...
        slot: "feet",
        stats: { agility: 5 },
        gameAsset: 'assets/equipment/SpiritstepBoots.png',
    ...
    "spiritguardHelm": {
        ...
        gameAsset: 'assets/equipment/SpiritguardHelm.png',
...
const EXPLORATION_AREAS = {
    ...
    "emeraldVeinHollow": {
        name: "Emerald Vein Hollow", requiredRealmTier: 1, description: "Where the earth’s first breath births the humblest herbs and whispering minerals.", monsters: [], image: "assets/areas/Emerald_Vein_Hollow.png",
        lootTable: [
            ...
            { itemId: 'breakthroughVine', chance: 0.15, minQuantity: 1, maxQuantity: 1 },
    ...
    "starlitMossGarden": {
        ...
        lootTable: [
            ...
            { itemId: 'dragonboneFern', chance: 0.12, minQuantity: 1, maxQuantity: 1 },
    ...
    "crimsonIronGrottos": {
        ...
        lootTable: [
            ...
            { itemId: 'phoenixbloodHerb', chance: 0.10, minQuantity: 1, maxQuantity: 1 },
            { itemId: 'divineFlameGrass', chance: 0.08, minQuantity: 1, maxQuantity: 1 },
            { itemId: 'lunarBloom', chance: 0.08, minQuantity: 1, maxQuantity: 1 },
            { itemId: 'spiritStones', chance: 0.15, minQuantity: 1, maxQuantity: 5 }
        ]
    },
    "lotusfireMarshlands": {
        ...
        lootTable: [
            ...
            { itemId: 'ascensionOrchid', chance: 0.08, minQuantity: 1, maxQuantity: 1 },
            { itemId: 'heavenpierceRoot', chance: 0.06, minQuantity: 1, maxQuantity: 1 },
    ...
    "mirrorwindHighlands": {
        ...
        lootTable: [
            ...
            { itemId: 'immortalDustleaf', chance: 0.07, minQuantity: 1, maxQuantity: 1 },
            { itemId: 'voidberryThorn', chance: 0.07, minQuantity: 1, maxQuantity: 1 },
    ...
    "eclipticDreamRealm": {
        name: "Ecliptic Dream Realm", requiredRealmTier: 6, description: "Where the world begins to blur—phantom blossoms, primal jade, and unformed Dao await.", monsters: [], image: "assets/areas/Ecliptic_Dream_Realm.png",
        lootTable: [
...
const ARTIFACT_RECIPES = {
    ...
    "stonewallPlateRecipe": {
        ...
        ingredients: { "spiritOreFragment": 5, "enchantedStoneDust": 2, "minorQiConductor": 1, "demonCore": 1 },
        requiredClass: "artifact_refiner", requiredCultivationLevel: 1, qiCost: 25
    },
    "stonewallBandRecipe": {
    ...
    "echoflowBandRecipe": {
        ...
        ingredients: { "spiritOreFragment": 2, "minorQiConductor": 1, "demonCore": 1 },
        requiredClass: "artifact_refiner", requiredCultivationLevel: 1, qiCost: 15
    },
    "echoflowShoesRecipe": {
        name: "Echoflow Shoes", producesItemKey: "echoflowShoes",
        ingredients: { "spiritOreFragment": 2, "enchantedStoneDust": 1, "demonCore": 1 },
        requiredClass: "artifact_refiner", requiredCultivationLevel: 1, qiCost: 15
    },
    "echoflowHoodRecipe": {
...
const DEFAULT_SECT_RANKS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            "promote_member_lower_rank", "demote_member_lower_rank",
    ...
    },
    {
        name: "Core Disciple",
        permissions: [
            "access_sect_storage_read", "access_sect_buffs",
            "buy_from_sect_shop", "donate_to_treasury"
        ],
    ...
    },
    {
        ...
        minContribution: 1000, isDefaultNewMember: true
    },
